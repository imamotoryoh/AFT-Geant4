...
void display2(){
  ...
  TFile* f1 = new TFile("../test_kk.root");
  ...
  //t1->SetBranchAddress("dE_fiberx_kminus",&dex);
  //t1->SetBranchAddress("dE_fibery_kminus",&dey);
  //t1->SetBranchAddress("dE_fiberx_kplus",&dex);
  //t1->SetBranchAddress("dE_fibery_kplus",&dey);
