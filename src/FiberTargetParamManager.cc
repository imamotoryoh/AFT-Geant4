...
FiberTargetParamManager::FiberTargetParamManager(G4String inputfilename)
...
FiberTargetParamManager::~FiberTargetParamManager()
{}

G4bool FiberTargetParamManager::readparam()
{
  G4String dummy;
  G4String Logfile;
