...
//
//
// $Id: FiberTargetMinEkineCuts.cc 69148 2013-04-19 10:35:21Z gcosmo $
//
// 
// --------------------------------------------------------------
...
FiberTargetMinEkineCuts::FiberTargetMinEkineCuts(const G4String& aName)
  : FiberTargetSpecialCuts(aName)
{
    if (verboseLevel>1) {
...
FiberTargetMinEkineCuts::FiberTargetMinEkineCuts(FiberTargetMinEkineCuts&)
  : FiberTargetSpecialCuts()
{}


G4double FiberTargetMinEkineCuts::PostStepGetPhysicalInteractionLength(
